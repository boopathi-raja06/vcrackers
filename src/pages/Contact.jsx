...
import banner from '../assets/diwali.png';

const Contact = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow mt-8 flex flex-col items-center">
      <img src={banner} alt="Mega Sale Banner" className="w-1/2 max-w-xl rounded-lg shadow mb-6" />
      ...
      <footer className="bg-gray-900 text-gray-100 w-1/2 max-w-xl py-6 mt-8 rounded-lg">
