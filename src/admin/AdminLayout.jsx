  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-start py-12 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 w-full max-w-5xl">
        {options.map(opt => (
          <a key={opt.name} href={opt.path} className="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center justify-center text-center hover:bg-red-50 transition cursor-pointer">
